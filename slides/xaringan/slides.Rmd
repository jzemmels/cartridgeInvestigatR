...
Use the "Import" tab to upload the scans in the `data/knownMatch` folder.
...
**Challenge**: Use the "Import" tab to upload the scans in the `data/questioned` folder. The first two scans, `x3p1` and `x3p2`, are known matches. Does the third scan, `x3p3`, match the other two? Use the app to inform your decision.
