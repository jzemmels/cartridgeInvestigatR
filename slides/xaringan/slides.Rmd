...
Click the "Page Refresh" button (F5 on your keyboard). Use the "Import" tab to upload the scans in the `data/questioned` folder.
There are three scans.
`x3p1` and `x3p2` are known matches while `x3p3` is from an unknown source.
All three scans have previously undergone preprocessing.

- First compare `x3p1` and `x3p2`. How do the similarity scores compare to your assessment of the similarity of the cartridge cases?
...
- **Challenge**: Does the third scan, `x3p3`, match the other two? Use the app to inform your decision.
