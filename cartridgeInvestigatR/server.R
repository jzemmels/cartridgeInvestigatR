...
server = function(input, output, session) {
    ...
    observeEvent(input$comparisonButton,{
        ...
        show_modal_progress_line(text = paste0("Comparing reference vs. target scans at rotation ",thetas[1],"°"))
        ...
        if(input$bothDirectionsCheck){
            ...
            show_modal_progress_line(text = "Comparing target vs. reference scans at rotation ",thetas[1],"°")
    ...
    observeEvent(input$postComparisonClick,{
        ...
        output$cellComparisonPlot <- renderPlot({
            ...
            return(fiveplot(alignedCellData,reference = input$referenceSelect,target = input$targetSelect,cell = unique(alignedCellData$cellIndex)))
    ...
    observeEvent(input$customCellExecute,{
        ...
        show_modal_progress_line(text = paste0("Comparing custom cell to ", otherScan," at rotation ",thetas[1],"°"))
        ...
        compData <- map2_dfr(thetas,
                            ...
                            function(theta,ind){
                                ...
                                comparison_customCell(refCell,target,theta,input$maxNonMissingProp)
